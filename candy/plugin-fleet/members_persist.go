...
// The former host-side per-member persist (charly/deploy_members.go's bringUpMembers →
...
// deployMarshalNode + loadDeployConfig (the loader-threaded Primaries leg + the cycle-free
